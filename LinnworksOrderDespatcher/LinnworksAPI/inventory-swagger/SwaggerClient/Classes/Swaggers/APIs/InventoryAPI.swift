...
open class InventoryAPI {
     ...
     */
    open class func addInventoryItems(body: [InventoryItemAddRequest], completion: @escaping ((_ data: BatchResponse?,_ error: Error?) -> Void)) {
  ...
  "Result" : "SUCCESSFUL"
     ...
     */
    open class func addInventoryItemsWithRequestBuilder(body: [InventoryItemAddRequest]) -> RequestBuilder<BatchResponse> {
        let path = "/inventory"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func deleteInventoryItem(itemId: UUID, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
     ...
     */
    open class func deleteInventoryItemWithRequestBuilder(itemId: UUID) -> RequestBuilder<Void> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func deleteInventoryItems(ids: String, completion: @escaping ((_ data: BatchResponse?,_ error: Error?) -> Void)) {
  ...
  "Result" : "SUCCESSFUL"
     ...
     - returns: RequestBuilder<BatchResponse> 
     */
    open class func deleteInventoryItemsWithRequestBuilder(ids: String) -> RequestBuilder<BatchResponse> {
        let path = "/inventory"
        let URLString = SwaggerClientAPI.basePath + path
        let parameters: [String:Any]? = nil
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getCategories(completion: @escaping ((_ data: [Category]?,_ error: Error?) -> Void)) {
  ...
  "CategoryName" : "CategoryName"
     ...
     */
    open class func getCategoriesWithRequestBuilder() -> RequestBuilder<[Category]> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getInventoryItem(itemId: UUID, completion: @escaping ((_ data: InventoryItem?,_ error: Error?) -> Void)) {
  ...
  "IsVariationParent" : true
     ...
     */
    open class func getInventoryItemWithRequestBuilder(itemId: UUID) -> RequestBuilder<InventoryItem> {
        var path = "/inventory/{item_id}"
        let itemIdPreEscape = "\(itemId)"
        let itemIdPostEscape = itemIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{item_id}", with: itemIdPostEscape, options: .literal, range: nil)
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getInventoryItems(ids: String, completion: @escaping ((_ data: [InventoryItem]?,_ error: Error?) -> Void)) {
  ...
  "IsVariationParent" : true
     ...
     - returns: RequestBuilder<[InventoryItem]> 
     */
    open class func getInventoryItemsWithRequestBuilder(ids: String) -> RequestBuilder<[InventoryItem]> {
        let path = "/inventory"
        let URLString = SwaggerClientAPI.basePath + path
        let parameters: [String:Any]? = nil
        var url = URLComponents(string: URLString)
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func updateInventoryItem(body: InventoryItemUpdateRequest, itemId: UUID, completion: @escaping ((_ data: InventoryItem?,_ error: Error?) -> Void)) {
  ...
  "IsVariationParent" : true
     ...
     - returns: RequestBuilder<InventoryItem> 
     */
    open class func updateInventoryItemWithRequestBuilder(body: InventoryItemUpdateRequest, itemId: UUID) -> RequestBuilder<InventoryItem> {
        var path = "/inventory/{item_id}"
        let itemIdPreEscape = "\(itemId)"
        let itemIdPostEscape = itemIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{item_id}", with: itemIdPostEscape, options: .literal, range: nil)
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func updateInventoryItems(body: [InventoryItemUpdateRequest], completion: @escaping ((_ data: BatchResponse?,_ error: Error?) -> Void)) {
  ...
  "Result" : "SUCCESSFUL"
     ...
     - returns: RequestBuilder<BatchResponse> 
     */
    open class func updateInventoryItemsWithRequestBuilder(body: [InventoryItemUpdateRequest]) -> RequestBuilder<BatchResponse> {
        let path = "/inventory"
        let URLString = SwaggerClientAPI.basePath + path
        let parameters = JSONEncodingHelper.encodingParameters(forEncodableObject: body)
        let url = URLComponents(string: URLString)
