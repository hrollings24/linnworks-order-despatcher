...
public struct InventoryItemAddRequest: Codable {
    ...
    public init(title: String, SKU: String, barcode: String, purchasePrice: Double? = nil, retailPrice: Double? = nil, taxRate: Float? = nil, categoryId: UUID? = nil, height: Double? = nil, width: Double? = nil, depth: Double? = nil, weight: Double? = nil, trackingType: Int? = nil, batchNumberScanRequired: Bool? = nil, serialNumberScanRequired: Bool? = nil, _id: Any? = nil) {
        self.title = title
        self.SKU = SKU
