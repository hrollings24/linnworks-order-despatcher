...
public struct InventoryItemRequest: Codable {
    ...
    public init(title: String? = nil, SKU: String? = nil, barcode: String? = nil, purchasePrice: Double? = nil, retailPrice: Double? = nil, taxRate: Float? = nil, categoryId: UUID? = nil, height: Double? = nil, width: Double? = nil, depth: Double? = nil, weight: Double? = nil, trackingType: Int? = nil, batchNumberScanRequired: Bool? = nil, serialNumberScanRequired: Bool? = nil, _id: UUID? = nil) {
        self.title = title
        self.SKU = SKU
